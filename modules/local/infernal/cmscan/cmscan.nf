...
process CMSCAN {
    ...
    """
    cmscan --rfam --cut_ga --nohmmonly --tblout mrum-genome.tblout --fmt 2 --clanin Rfam.clanin ${fasta_file} > mrum-genome.cmscan

    cat <<-END_VERSIONS > versions.yml
    "${task.process}":
        cmscan: \$(samtools --version |& sed '1!d ; s/samtools //')
    END_VERSIONS
    """
